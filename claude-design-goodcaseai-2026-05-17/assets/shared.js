/* GoodCaseAI shared chrome — nav, ticker, footer. Injects markup so every
   secondary page shares structure + locale hooks without duplication. */
...
<section class="final">
  ...
  <div class="wrap">
    ...
    <div style="margin-top:56px;display:flex;justify-content:center;gap:32px;font-family:'JetBrains Mono',monospace;font-size:10.5px;color:var(--mute);letter-spacing:.08em;">
...
<footer>
    ...
    <div class="grid">
      ...
      <div>
        ...
        <ul>
          ...
          <li><a href="love-ranking.html" data-i18n="ft.c1.4">Cases</a></li>
  ...
  // run before i18n.js applies translations — both scripts are synchronous
