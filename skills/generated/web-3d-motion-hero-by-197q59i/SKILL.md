---
name: web-3d-motion-hero-by-197q59i
description: "Apply an evidence-derived 3D and motion hero workflow observed across published GoodCase examples by viktoroddy. Use when planning, designing, or implementing a website in this interface pattern, including requests for 网页, 落地页, 作品集, 3D hero, SaaS, ecommerce, or UI structure. This is an unofficial synthesis and must preserve source attribution."
---

# viktoroddy · 3D and motion hero
...
3. Choose one visual protagonist.
4. Specify scroll or interaction triggers.
5. Limit first-load assets and mobile fallback.
