---
name: action-continuity-choreography
description: "Apply the Action continuity choreography workflow derived from multiple published GoodCase examples. Use when planning, storyboarding, or refining an AI video prompt in this motion pattern, including requests for 视频提示词, 分镜, 动作复刻, reference images, source video, or special generation steps. Read the bundled evidence when provenance or examples matter."
---
...
3. Fix character and movement direction.
4. Split setup, conflict, and resolution.
5. Constrain camera, speed, and continuity shot by shot.
