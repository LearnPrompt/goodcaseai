...
description: "Apply the Product and commerce conversion page workflow derived from multiple published GoodCase examples. Use when planning, designing, or implementing a website in this interface pattern, including requests for 网页, 落地页, 作品集, 3D hero, SaaS, ecommerce, or UI structure. Read the bundled Case evidence before producing an artifact."
---
...
5. Clarify product and audience above the fold.
6. Resolve price, trust, and choice friction.
7. Complete purchase or signup with a clear CTA.
