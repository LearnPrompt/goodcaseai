---
name: product-commerce-conversion-page
description: "Apply the Product and commerce conversion page workflow derived from multiple published GoodCase examples. Use when planning, designing, or implementing a website in this interface pattern, including requests for 网页, 落地页, 作品集, 3D hero, SaaS, ecommerce, or UI structure. Read the bundled evidence when provenance or examples matter."
---

# Product and commerce conversion page
...
3. Clarify product and audience above the fold.
4. Resolve price, trust, and choice friction.
5. Complete purchase or signup with a clear CTA.
