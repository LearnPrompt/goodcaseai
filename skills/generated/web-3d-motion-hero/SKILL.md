---
name: web-3d-motion-hero
description: "Apply the 3D and motion hero workflow derived from multiple published GoodCase examples. Use when planning, designing, or implementing a website in this interface pattern, including requests for 网页, 落地页, 作品集, 3D hero, SaaS, ecommerce, or UI structure. Read the bundled evidence when provenance or examples matter."
---
