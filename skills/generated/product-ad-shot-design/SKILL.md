---
name: product-ad-shot-design
description: "Apply the Product ad shot design workflow derived from multiple published GoodCase examples. Use when planning, storyboarding, or refining an AI video prompt in this motion pattern, including requests for 视频提示词, 分镜, 动作复刻, reference images, source video, or special generation steps. Read the bundled evidence when provenance or examples matter."
---
...
3. Choose one product benefit.
4. Prove it through action or context.
5. Close on brand detail or a call to action.
