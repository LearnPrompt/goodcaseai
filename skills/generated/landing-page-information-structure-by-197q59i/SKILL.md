---
name: landing-page-information-structure-by-197q59i
description: "Apply an evidence-derived Landing-page information structure workflow observed across published GoodCase examples by viktoroddy. Use when planning, designing, or implementing a website in this interface pattern, including requests for 网页, 落地页, 作品集, 3D hero, SaaS, ecommerce, or UI structure. This is an unofficial synthesis and must preserve source attribution."
---

# viktoroddy · Landing-page information structure
...
3. Keep one value proposition above the fold.
4. Order problem, proof, and features.
5. Make every section lead to one action.
